...
This project's goal was to build a program that emulates what is happening under the hood at the assembly code level. More specifically...
...
To give an example of an ARM instruction:
LDM  R8, {R0,R2,R9}  
